...
<body> 
 ...
 <h2 class="text-center"> Cadastre-se como Pesquisador </h2>
 
 <form action="cadastraPesquisador.php" method="post">
     <fieldset style="margin-left: 50px">
         <legend class="fw-bold"> Cadastro de Pesquisador </legend> 
         ...
         <div class="row mb-3" style="width: 500px">
             ...
             <div class="col-sm-10">
                 <input type="number" class="form-control" id="Cep" name="cep" placeholder="Somente Números" style="height: 30px; margin-top: 4px;">
             </div>
         </div>
         <div class="row mb-3" style="width: 500px">
         ...
         <div>
             <button type="submit" class="btn btn-primary" name="cadastrar"> Cadastre-se como Pesquisador </button>
 ...
 <?php  
   ...
   if(isset($_POST['cadastrar']))
    ...
    $pesquisador->cadastrar($conexao, $banco->nomeDaTabela);
    echo '<script> alert ("Pesquisador cadastrado com Sucesso!"); location.href=("index.php")</script>';
    }
